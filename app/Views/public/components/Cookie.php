<div class="container-fluid p-5 d-flex d-none position-fixed bottom-0 bg-blue text-white" style="z-index: 900;" id="cookie-banner-container">
    <div class="row">
...
<?php include 'app/Views/public/components/CookieModal.php' ?>